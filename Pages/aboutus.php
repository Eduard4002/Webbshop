    ...
    <main>
        ...
        <div class = "person">
            ...
            <div class="Ram">
                ...
                <div class = "textcont">
                    <h2 style = "color: #38d94e;">Rami Agha Graphical Designer</h2>
                    <div class = "textcontdesc">
                        <p style = "display: block;">My first ever project in Web development. Head of front-end/Graphical Design for the {Retro-Tech} website using Figma, HTML and CSS.</p>
            ...
            <div class="Jon">
                ...
                <div class = "textcont">
                    <h2 style = "color: #f02236;">Jonathan Cano Sjöstedt Graphical Designer</h2>
                    <div class = "textcontdesc">
